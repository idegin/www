          ...
          <Reveal className="lg:col-span-6" delay={80}>
            ...
            >
              ...
              <div className="mt-3 flex flex-col gap-3 sm:flex-row">
                ...
                <button
                  type="submit"
                  className="group inline-flex h-13 items-center justify-center gap-2 rounded-md bg-brand px-6 text-base font-medium text-on-brand shadow-sm transition duration-200 hover:bg-brand-hover hover:shadow-glow"
                >
                  Subscribe
                  <IconArrowRight className="h-4 w-4 transition-transform duration-200 group-hover:translate-x-0.5" />
                </button>
              ...
              <p className="mt-4 text-sm text-ink-300">
                Prefer to talk it through first? Book a discovery session and
                skip the queue.
              </p>
              <div className="mt-5">
